<footer class="footer mt-5">
    <div class="footer-container">
        <div class="footer-column">
            ...
            <p>
                Estudio Jurídico Tributario comprometido con el éxito de tu empresa. Brindamos soluciones integrales en
                el ámbito legal, tributario y financiero.
            </p>
        </div>
        <div class="footer-column">
            <h3 class="footer-title">Enlaces Administrador</h3>
            <ul class="footer-links">
                <li><a href="{{ route('admin.home') }}">Inicio Admin</a></li>
                <li><a href="{{ route('admin.services.index') }}">Nuestros Servicios</a></li>
                <li><a href="{{ route('admin.about.edit') }}">Sobre Nosotros</a></li>
                <li><a href="{{ route('admin.blog.index') }}">Blog Informativo</a></li>
                <li><a href="{{ route('admin.contact.edit') }}">Contáctanos</a></li>
            </ul>
        </div>
        <div class="footer-column">
