...
<div class="container-fluid bg-dark text-light mt-4 p-4 rounded">
    ...
    <form action="{{ route('admin.home.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="main_title" name="content[main_title]" value="{{ $sections['main_title']->content ?? '' }}">
        </div>

        {{-- Subtítulo principal --}}
        <div class="mb-3">
            <label for="main_subtitle" class="form-label">Subtítulo principal</label>
            <input type="text" class="form-control" id="main_subtitle" name="content[main_subtitle]" value="{{ $sections['main_subtitle']->content ?? '' }}">
        </div>
        ...
        <div class="mb-3">
            ...
            @if(!empty($sections['main_image']->image_path))
                <img src="{{ asset('storage/'.$sections['main_image']->image_path) }}" alt="Imagen Principal" class="img-fluid mb-2" style="max-width: 100%;">
            @endif
        ...
        <div class="mb-3">
            ...
            @if(!empty($sections['second_image']->image_path))
                <img src="{{ asset('storage/'.$sections['second_image']->image_path) }}" alt="Segunda Imagen" class="img-fluid mb-2" style="max-width: 100%;">
            @endif
        ...
        <div class="mb-3">
            ...
            @if(!empty($sections['third_image']->image_path))
                <img src="{{ asset('storage/'.$sections['third_image']->image_path) }}" alt="Tercera Imagen" class="img-fluid mb-2" style="max-width: 100%;">
            @endif
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="team_title" name="content[team_title]" value="{{ $sections['team_title']->content ?? '' }}">
        </div>

        {{-- ¿Quiénes somos? --}}
        <div class="mb-3">
            <label for="about_title" class="form-label">Título ¿Quiénes somos?</label>
            <input type="text" class="form-control" id="about_title" name="content[about_title]" value="{{ $sections['about_title']->content ?? '' }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="_offer_title" name="content[offer_title]" value="{{ $sections['offer_title']->content ?? '' }}">
        </div>
        <div class="mb-3">
            <label for="offer_list" class="form-label">Lista de ofertas (HTML)</label>
            <textarea class="form-control" id="offer_list" name="content[offer_list]" rows="4">{{ $sections['offer_list']->content ?? '' }}</textarea>
            <small class="text-muted d-block mt-1">Puedes usar etiquetas &lt;li&gt; para cada elemento.</small>
        </div>

        {{-- Misión --}}
        <div class="mb-3">
            <label for="mission_title" class="form-label">Título Misión</label>
            <input type="text" class="form-control" id="mission_title" name="content[mission_title]" value="{{ $sections['mission_title']->content ?? '' }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="vision_title" name="content[vision_title]" value="{{ $sections['vision_title']->content ?? '' }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="contact_title" name="content[contact_title]" value="{{ $sections['contact_title']->content ?? '' }}">
        </div>
        <div class="mb-3">
