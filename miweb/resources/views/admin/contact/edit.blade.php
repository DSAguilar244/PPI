...
<div class="container bg-dark text-light mt-4 p-4 rounded">
    ...
    <form method="POST" action="{{ route('admin.contact.update') }}">
        ...
        <div class="mb-3">
            <label>Texto Nombre Completo</label>
        ...
        <div class="mb-3">
            <label>Texto de fondo Nombre Completo</label>
        ...
        <div class="mb-3">
            <label>Texto de fondo Correo Electrónico</label>
        ...
        <div class="mb-3">
            <label>Texto Nombre de la Empresa</label>
        ...
        <div class="mb-3">
            <label>Texto de fondo Nombre de la Empresa</label>
        ...
        <div class="mb-3">
            <label>Texto Tipo de Consulta</label>
        ...
        <div class="mb-3">
            <label>Texto de fondo de Mensaje</label>
        ...
        <div class="mb-3">
            <label>Texto del Mensaje de Error de Correo</label>
