...
@section('content')
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="service-card">
                        <img src="{{ asset('static/img/ase_tributario.jpeg') }}" class="d-block w-100" alt="Asesoría Tributaria">
                ...
                <div class="col-md-4">
                    <div class="service-card">
                        <img src="{{ asset('static/img/consul_juridica.webp') }}" class="d-block w-100" alt="Consultoría Empresarial">
                        <div class="service-info">
                ...
                <div class="col-md-4">
                    <div class="service-card">
                        <img src="{{ asset('static/img/fiscal_estrategica.jpg') }}" class="d-block w-100" alt="Planeación Fiscal">
                        <div class="service-info">
                ...
                <div class="col-md-4">
                    <div class="service-card">
                        <img src="{{ asset('static/img/asistencia_juridica.webp') }}" class="d-block w-100" alt="Planeación jurídica">
                        <div class="service-info">
                ...
                <div class="col-md-4">
                    <div class="service-card">
                        <img src="{{ asset('static/img/acompañamiento_abogado.webp') }}" class="d-block w-100" alt="Acompañamiento en procesos">
                        <div class="service-info">
    ...
    <div class="modal fade" id="serviceModal2" tabindex="-1" aria-labelledby="serviceModal2Label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="serviceModal2Label">Patrocinio Legal</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <img src="{{ asset('static/img/consul_juridica.webp') }}" alt="Consultoría Empresarial" class="w-100">
    ...
    <div class="modal fade" id="serviceModal3" tabindex="-1" aria-labelledby="serviceModal3Label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="serviceModal3Label">Gestión de Cobranza</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" id="serviceModal4" tabindex="-1" aria-labelledby="serviceModal4Label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('static/img/asistencia_juridica.webp') }}" alt="Planeación jurídica" class="w-100">
    ...
    <div class="modal fade" id="serviceModal5" tabindex="-1" aria-labelledby="serviceModal5Label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('static/img/acompañamiento_abogado.webp') }}" alt="Acompañamiento en procesos" class="w-100">
