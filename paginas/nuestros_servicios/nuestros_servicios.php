            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                    <ul class="navbar-nav text-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../../paginas/nuestros_servicios/nuestros_servicios.php">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="service-card">
                        <img src="../../static/img/ase_tributario.jpeg" class="d-block w-100" alt="Asesoría Tributaria">
                ...
                <div class="col-md-4">
                    <div class="service-card">
                        <img src="../../static/img/consul_juridica.webp" class="d-block w-100" alt="Consultoría Empresarial">
                        <div class="service-info">
                ...
                <div class="col-md-4">
                    <div class="service-card">
                        <img src="../../static/img/fiscal_estrategica.jpg" class="d-block w-100" alt="Planeación Fiscal">
                        <div class="service-info">
...
<div class="col-md-4">
    <div class="service-card">
        <img src="../../static/img/asistencia_juridica.webp" class="d-block w-100" alt="Planeación jurídica">
        <div class="service-info">
...
<div class="col-md-4">
    <div class="service-card">
        <img src="../../static/img/acompañamiento_abogado.webp" class="d-block w-100" alt="Acompañamiento en procesos">
        <div class="service-info">
...
<div class="col-md-4">
    <div class="service-card">
        <img src="../../static/img/defensa_casos.jpg" class="d-block w-100" alt="Defensa casos">
        <div class="service-info">
    ...
    <section class="cta-section text-center">
        <div class="container">
            ...
            <button onclick="window.location.href='../../paginas/contactanos/contactanos.php'">Contáctanos</button>
        </div>
    </section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="../../static/img/ase_tributario.jpeg" alt="Asesoría Tributaria">
...
<div class="modal fade" id="serviceModal2" tabindex="-1" aria-labelledby="serviceModal2Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="../../static/img/consul_juridica.webp" alt="Consultoría Empresarial">
...
<div class="modal fade" id="serviceModal3" tabindex="-1" aria-labelledby="serviceModal3Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="../../static/img/fiscal_estrategica.jpg" alt="Planeación Fiscal">
...
<div class="modal fade" id="serviceModal4" tabindex="-1" aria-labelledby="serviceModal4Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="../../static/img/asistencia_juridica.webp" alt="Planeación jurídica">
...
<div class="modal fade" id="serviceModal5" tabindex="-1" aria-labelledby="serviceModal5Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="../../static/img/acompañamiento_abogado.webp" alt="Acompañamiento en procesos">
...
<div class="modal fade" id="serviceModal6" tabindex="-1" aria-labelledby="serviceModal6Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="../../static/img/defensa_casos.jpg" alt="Defensa casos">
