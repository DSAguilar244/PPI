            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                    <ul class="navbar-nav text-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../../paginas/sobre_nosotros/sobre_nosotros.php">
        ...
        <div class="container">
            ...
            <div class="section-content" style="text-align: justify;" >
                ...
                <div>
                    ...
                    <img src="../../static/img/logo asesoro mediano.webp" alt="Historia" class="img-fluid mt-3">
                </div>
                <!-- Mission Section -->
                <div>
                    <h3>Misión</h3>
                    ...
                    <img src="../../static/img/mision_asesoro.jpg" alt="Misión" class="img-fluid mt-3">
                </div>
                <!-- Vision Section -->
                <div>
                    <h3>Visión</h3>
                    ...
                    <img src="../../static/img/vision_asesoro.jpg" alt="Visión" class="img-fluid mt-3">
                </div>
            </div>
        </div>
    </section>
